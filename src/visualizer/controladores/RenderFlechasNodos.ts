...
nodoMóvil?.classList.remove("no-mover", "inmediato-nodo");
     ...
     console.log("La cantidad de nodos en la fila es :",cantidadNodosFila);
      if (cantidadNodosFila > 1) {
        ...
        // const indiceInicio = (metodo===1) ? iLocal : layout.indiceInicioUltimaFila;
        // console.log("El indice local es: ",indiceInicio);
        // console.log("La cantidad de nodos en esta fila es: ",cantidadNodosFila);
  ...
  if (nodoMóvil && layout.totalFilas > 1) {
    ...
    //     console.log("El indice local es: ",iLocal);
    //     console.log("La cantidad de nodos en esta fila es: ",cantidadNodosFila);

    //     const indiceParaFlechas = (iLocal + 1) - cantidadNodosFila ;
    //     console.log("El indice para flechas comienza en: ",indiceParaFlechas);
    //     for(let j = indiceParaFlechas  ; j < (indiceParaFlechas +(cantidadNodosFila - 1)) ; j++){
    ...
    //       if (nodos[j+1]) {
    //         nodos[j+1].classList.remove("no-mover");
    //         nodos[j+1].classList.remove("inmediato-nodo");
    //         if (metodo === 1) {
    //           nodos[j+1].style.left = (cantidadNodosFila - (j+1)) * (s1 - s2) + 'px';
    //         } else {
    //           nodos[j+1].style.left = (j + 2) * (s2 - s1) + 'px';
    //         }
    //       }
    //       console.log("Indice del nodo que no se mueve: ",j+1);
    //       console.log("Aca abajo el nodo que no se mueve lpm: ")
    //       console.log(nodos[j+1]);
    //     }
    //   }
