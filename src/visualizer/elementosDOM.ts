...
// export const inicialUl = () => flechaPunteroInicial?.querySelector(".underline") as HTMLElement | null;
// export const inicialLs = () => flechaPunteroInicial?.querySelector(".linea-s") as HTMLElement | null;
// export const inicialLi = () => flechaPunteroInicial?.querySelector(".linea-i") as HTMLElement | null;

// export const finalUl = () => flechaPunteroFinal?.querySelector(".underline") as HTMLElement | null;
// export const finalLs = () => flechaPunteroFinal?.querySelector(".linea-s") as HTMLElement | null;
// export const finalLi = () => flechaPunteroFinal?.querySelector(".linea-i") as HTMLElement | null;
