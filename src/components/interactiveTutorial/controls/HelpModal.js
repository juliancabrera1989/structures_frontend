...
//   return (
//     <Modal show={show} onHide={onHide} centered bg="dark" className="text-light">
//       <Modal.Header closeButton closeVariant="white" className="bg-dark border-secondary">
//         <Modal.Title className="text-info fw-bold">Guía Rápida del Visualizador</Modal.Title>
//       </Modal.Header>
//       <Modal.Body className="bg-dark text-light">
//         <p className="text-secondary small">
//           Sigue estos sencillos pasos para manipular nodos y punteros en tiempo real sobre el lienzo visual:
//         </p>
//         <ListGroup variant="flush">
//           <ListGroup.Item className="bg-dark text-light border-secondary">
//             <strong className="text-warning">1. Crear la Estructura:</strong> Asigna un nombre, elige el tipo de estructura (Pila, Cola, Lista) y el tipo de dato que almacenarán los nodos. Presiona <span className="badge bg-info text-dark">Crear Estructura</span>.
//           </ListGroup.Item>
//           <ListGroup.Item className="bg-dark text-light border-secondary">
//             <strong className="text-warning">2. Insertar Nodos:</strong> Escribe un valor en el campo de texto y utiliza los botones para insertar al comienzo, al final o en una posición intermedia.
//           </ListGroup.Item>
//           <ListGroup.Item className="bg-dark text-light border-secondary">
//             <strong className="text-warning">3. Inspeccionar Punteros:</strong> Observa cómo los punteros (<code className="text-info">head</code>, <code className="text-info">tail</code>, <code className="text-info">next</code>) se reasignan dinámicamente en el lienzo.
//           </ListGroup.Item>
//           <ListGroup.Item className="bg-dark text-light border-secondary">
//             <strong className="text-warning">4. Guardar Trabajo:</strong> Si iniciaste sesión, presiona <span className="badge bg-success">Guardar</span> para almacenar tu estructura en la nube y acceder a ella desde tu Dashboard.
//           </ListGroup.Item>
//         </ListGroup>
//       </Modal.Body>
//       <Modal.Footer className="bg-dark border-secondary">
//         <Button variant="info" onClick={onHide} className="fw-bold">
//           Entendido, ¡a probar! 🚀
//         </Button>
//       </Modal.Footer>
//     </Modal>
